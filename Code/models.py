...
def se_block(x, num_filters, reduction=16):
    x_input = x
    x = GlobalAveragePooling2D()(x)
    x = Dense(num_filters // reduction, activation='relu', use_bias=False)(x)
    x = Dense(num_filters // reduction, use_bias=False, activation='sigmoid')(x)
